...
import type { DebugMapData, DebugMapRiverData } from "./DebugOverlayTypes"

export class DebugMapRenderer {
  public constructor(
    private readonly _player: PlayerController,
    private readonly _onPlayerPlaced: () => void,
  ) {}

  public render(data: DebugMapData): void {
